...
//social-functions.php controller
...
if ($action == "socialFunctions") {
  $seoId = trim($_GET['seoId']);
  $venueService = new VenueService();
  $rowSocialFunctions = $venueService->socialFunctions($seoId);
  if (empty($rowSocialFunctions)) {
    $constants = new Constants();
    header("Location:" . $constants->DOMAIN_URL);
    die;
  }
  require_once ("../view/social-functions-content.php");
}
