        ...
        <div class="box">
          ...
          <div class="fullboxBg">
            <div class="boxContent">
              <div class="boxGr">
                <!-- Box Content Start -->
                <h3>Search Your Venue</h3>
                <form name="searchForm" class="contactform" action="#">
				<input class="input-txt" type="text" value="Enter Your Keyword" name="s" onfocus="if(this.value=='Enter Your Keyword')this.value='';" onblur="if(this.value=='')this.value='Enter Your Keyword';" />
                  <input type="image" src="../images/btn-search.png" class="button-s" onclick="return redirectToHost('<?php echo $constants->DOMAIN_URL?>');"/> 
          ...
          <div class="fullboxBg">
            <div class="boxContent">
              <div class="boxGr">
                <!-- Box Content Start -->
                <img src="../images/divider.png" align="left" alt="" />
