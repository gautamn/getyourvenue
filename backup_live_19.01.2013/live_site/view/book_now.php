            ...
            <div class="boxContent booknow">
              <div class="boxGr boxheight">
                ...
                <form class="contactform" name="bookNowForm" method="POST"> <!--action="/booking-confirmation" -->
					...
					onfocus="if(this.value=='Enter Your Name'){this.value=''}" class="input-txt" />
					...
					<input type="text" name="contactNumber" value="Enter your Contact Number" onblur="if(this.value==''){this.value='Enter your Contact Number'}" onfocus="if(this.value=='Enter your Contact Number'){this.value=''}" class="input-txt" />
					...
					<input type="text" name="venueId" value="Enter your Preferred Venue" onblur="if(this.value==''){this.value='Enter your Preferred Venue'}" onfocus="if(this.value=='Enter your Preferred Venue'){this.value=''}" class="input-txt" />
					...
					<input type="text" name="no_of_guests" value="Enter your No. of Guests" onblur="if(this.value==''){this.value='Enter your No. of Guests'}" onfocus="if(this.value=='Enter your No. of Guests'){this.value=''}" class="input-txt" />
					
					<label>Budget(in INR):</label>
					
					<input type="text" name="budget" value="Enter your Budget(in INR)" onblur="if(this.value==''){this.value='Enter your Budget(in INR)'}" onfocus="if(this.value=='Enter your Budget(in INR)'){this.value=''}" class="input-txt" />
