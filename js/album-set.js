...
$(function() {
      ...
      $ps_albums.children('div').slice(first,parseInt(first+3)).each(
        function(i){
          ...
          $elem.animate({
            ...
            ++cnt;
            if(cnt == 3){
              $ps_albums.children('div:nth-child('+parseInt(first+4)+')').animate({
  ...
  function moveLeft () {
    ...
    var cnt = 0;
    var last= first+3;
    $ps_albums.children('div:nth-child('+last+')').animate({
      'left': hiddenRight + 'px',
      'opacity':0
    },500,function(){
      var $this = $(this);
      $ps_albums.children('div').slice(parseInt(last-4),parseInt(last-1)).each(
        function(i){
          ...
          $elem.animate({
            ...
            ++cnt;
            if(cnt == 3){
              $ps_albums.children('div:nth-child('+parseInt(last-4)+')').animate({
                'left': positions[0] + 'px',
                'opacity':1
              },500,function(){
                //$this.hide();
  ...
  $ps_albums.children('div').bind('click',function(){
    var $elem = $(this);
    var album_name = $.trim($elem.find('img').attr('rel'));//'album' + parseInt($elem.index() + 1);
    var album_desc = $.trim($elem.find('img').attr('alt'));
    ...
    $.get('/photostack', {
      ...
      for(var i = 0; i < items_count; ++i){
        ...
        }).attr('src',item_source).attr('alt',album_desc+' photo '+i).attr('title',album_desc+' photo '+i);
      }
    },'json');
  });
