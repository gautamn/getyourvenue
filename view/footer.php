      ...
      <div class="boxContent">
        <div class="boxGr">
          ...
          <ul class="content" style="width: 250px;">
            ...
            <li><a href="<?php echo $constants->DOMAIN_URL . 'wedding-venues-in-mundka'; ?>" title="Mundka and Rohtak Road">Mundka and Rohtak Road</a>, <?php /* <a href="#" title="5 Star Banquets">5 Star Banquets</a>, <a href="#" title="Destination Wedding">Destination Wedding</a>, */ ?><a href="<?php echo $constants->DOMAIN_URL . 'wedding-venues-in-delhi-ncr'; ?>" title="Others">Others</a></li>
          </ul>
          <!--<ul class="content" style="width:180px;">-->
