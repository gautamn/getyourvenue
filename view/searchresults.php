                  ...
                  <div class="boxContent">
                    <div class="boxGr">
                      <div class="searchImg f-left">
                        <?php echo '<a title="'.$venueList[$i]->venueName.'" href="'.$constants->DOMAIN_URL . 'venue/' . $venueList[$i]->venueId .'"><img src="' . $constants->IMAGE_PATH . 'venue/' . $venueList[$i]->id . '/thumbnail.jpg" alt="' . ($venueList[$i]->altTag != "" ? $venueList[$i]->altTag : $venueList[$i]->venueName) . '" /></a>'; ?>
                      </div>
                      <div class="searchDec f-right">
  <?php
  $content = stripslashes($venueList[$i]->content);
  echo "<h1><a title='" . $venueList[$i]->venueName . "' href='" . $constants->DOMAIN_URL . "venue/" . $venueList[$i]->venueId . "'>" . $venueList[$i]->venueName . "</a></h1><p>";
  echo $venueList[$i]->venueAddr1 . "<br />";
  echo $venueList[$i]->venueAddr2 . "<br /><br />";
  echo substr($content, 0, 115) . '... <a href="' . $constants->DOMAIN_URL . 'venue/' . $venueList[$i]->venueId . '#imageGallery"><b>more</b></a></p>';
  ?>
                        <div class="searchResultBtns">
                          <a title="Image Gallery" href="<?php echo $constants->DOMAIN_URL . "venue/" . $venueList[$i]->venueId . "#imageGallery"; ?>" class="imgGalleryBtn f-left">Image Gallery</a>
                          <a title="Book Now" href="<?php echo $constants->DOMAIN_URL . "venue/" . $venueList[$i]->venueId . "#bookNow"; ?>" class="locationMapBtn f-right">Book Now</a>
                          <a title="Location Map" href="<?php echo $constants->DOMAIN_URL . "venue/" . $venueList[$i]->venueId . "#location"; ?>" class="BookNowBtn f-right">Location Map</a>
                        </div>
                      </div>
                    </div>
                  </div>
