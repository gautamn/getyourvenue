...
<title><?php echo $rowSocialFunctions[0]->title;?></title>
<meta name="description" content="<?php echo $rowSocialFunctions[0]->metaDescription ?>" />
<meta name="keyword" content= "<?php echo $rowSocialFunctions[0]->metaKeyword ?>" />
            ...
            <div class="boxContent">
              <div class="boxGr">
                ...
                <?php
                    ...
                    $handler = opendir("..".$rowSocialFunctions[0] ->jcarouselPath);
            ...
            <div class="boxContent">
              <div class="boxGr">
                ...
                <form class="getVenue" name="bookVenueForm" method="POST">
                  ...
                  <input type="hidden" name="serviceName" value="<?php echo $rowSocialFunctions[0] ->title ?>" />
                </form>
                <!-- Box Content End -->
              </div>
            </div>
